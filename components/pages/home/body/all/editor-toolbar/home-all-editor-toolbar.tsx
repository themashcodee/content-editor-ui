...
export const EditorToolbar: Component<P> = ({ editor }) => {
	return (
		<div className="bg-gray-100 rounded-lg w-full flex gap-3 p-4 flex-wrap">
			...
			<EditorButton
				isActive={editor.isActive("horizonatalRule")}
			...
			<EditorButton ariaLabel="Undo Action" command={editor.chain().undo().run}>
				<svg
					xmlns="http://www.w3.org/2000/svg"
					viewBox="0 0 24 24"
					className="w-5 h-5"
			...
			<EditorButton ariaLabel="Redo Action" command={editor.chain().redo().run}>
				<svg
					xmlns="http://www.w3.org/2000/svg"
					viewBox="0 0 24 24"
					className="w-5 h-5"
